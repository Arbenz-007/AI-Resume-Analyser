...
const upload = () => {
  ...
  const handleAnalyse = async ({
    ...
    if (!imageFile.file)
      return setStatusText("Error : Failed to ocnvert PDf to image");
    ...
    if (!feedback) return setStatusText("ErrorL Failed to analyse resume");
      ...
      <section className="main-section">
        <div className="page-heading py-16">
          ...
          {isprocessing ? (
            ...
            <h2> Drop your resume for an ATS score and improvemnet tips</h2>
          )}
          {!isprocessing && (
            <form
              id="upload=form"
              onSubmit={handleSubmit}
              className="felx flex-col gap-4 mt-8"
            >
